<html lang="es">
    <head>
        ...
        <title>Tipos de Unidades de Medida</title>
    </head>
    <body >
        <div class="page-title">
            <h3 class="title">Tipos de Unidades de Medida</h3>
        </div>
        <div class="row">
            <!--<div class="col-md-12 col-md-12 col-xs-12">-->
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="cargarDiv('#window', 'vistas/com/unidad/unidad_tipo_form.php')"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
